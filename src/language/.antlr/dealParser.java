...
public class dealParser extends Parser {
	...
	public static final int
		...
		COMMENT=39, MOVE_DEST=40, MOVE_SOURCE=41, WILDCARD=42, NUMBER=43, ID=44, 
		CARD=45, STRING=46, SPACES=47, NEWLINE=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "COMMENT", "MOVE_DEST", "MOVE_SOURCE", "WILDCARD", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 20890725816388L) != 0)) {
				{
				{
				setState(68);
				stmt();
	...
	public final LogContext log() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 135239930216452L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
