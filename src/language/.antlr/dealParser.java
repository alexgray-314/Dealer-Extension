...
public class dealParser extends Parser {
	...
	public static final int
		...
		ID=58, CARD=59, STRING=60, SPACES=61, NEWLINE=62;
	public static final int
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 288245769535406116L) != 0)) {
				{
				{
				setState(82);
				stmt();
	...
	public final LogContext log() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 2305576927399772164L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AttsContext atts() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2305576927399772164L) != 0)) {
				{
				setState(260);
				attribute();
				setState(265);
	...
	public final PrimitivesContext primitives() throws RecognitionException {
		...
		try {
			...
			setState(335);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 143833713099145216L) != 0)) ) {
