...
public class dealParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, T__33=34, T__34=35, COMMENT=36, SPACES=37, NEWLINE=38, 
		NUMBER=39, ID=40, CARD=41;
	public static final int
		...
		RULE_updateTurn = 10, RULE_arearef = 11, RULE_position = 12, RULE_term = 13, 
		RULE_property = 14, RULE_bexpr = 15, RULE_aexpr = 16, RULE_set = 17, RULE_intset = 18, 
		RULE_positionset = 19, RULE_playerset = 20, RULE_move_catch = 21;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "stmt", "player", "assign", "definition", "move", "on_action", 
			"on_move", "for", "if", "updateTurn", "arearef", "position", "term", 
	...
	public final IntsetContext intset() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_intset);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(206);
	...
	public final PositionsetContext positionset() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_positionset);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(210);
	...
	public final PlayersetContext playerset() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_playerset);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(221);
	...
	public final Move_catchContext move_catch() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_move_catch);
		try {
			setState(227);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
