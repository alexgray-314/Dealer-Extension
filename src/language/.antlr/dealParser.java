...
public class dealParser extends Parser {
	...
	public static final int
		...
		MOVE_DEST=39, MOVE_SOURCE=40, WILDCARD=41, NUMBER=42, ID=43, CARD=44, 
		STRING=45, SPACES=46, NEWLINE=47;
	public static final int
		...
		RULE_function_call = 14, RULE_updateTurn = 15, RULE_log = 16, RULE_variable = 17, 
		RULE_args = 18, RULE_arg = 19, RULE_arearef = 20, RULE_area = 21, RULE_stack = 22, 
		RULE_position = 23, RULE_term = 24, RULE_property = 25, RULE_bexpr = 26, 
		RULE_aexpr = 27, RULE_set = 28, RULE_intset = 29, RULE_positionset = 30, 
		RULE_playerset = 31, RULE_move_catch = 32;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "COMMENT", "MOVE_DEST", "MOVE_SOURCE", "WILDCARD", "NUMBER", 
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8796097910852L) != 0)) {
				{
				{
				setState(66);
				stmt();
	...
	public final LogContext log() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 67619965108228L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArearefContext arearef() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_arearef);
		try {
			setState(199);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final AreaContext area() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_area);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(201);
	...
	public final BexprContext bexpr() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_bexpr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final AexprContext aexpr() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_aexpr);
		try {
			setState(246);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final IntsetContext intset() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_intset);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PositionsetContext positionset() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_positionset);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(261);
	...
	public final PlayersetContext playerset() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_playerset);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(268);
	...
	public final Move_catchContext move_catch() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_move_catch);
		try {
			setState(275);
			_errHandler.sync(this);
